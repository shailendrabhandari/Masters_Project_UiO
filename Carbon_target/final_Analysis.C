...
int main(int argc, char **argv) {
    ...
    */
    ...
    TFile *rootfile = new TFile("three_Analysis_All_DALI_on_19_ADD_av.intpoint_may_2021.root","RECREATE");
...
////...........................////
TH1F *hEnergy_mult2_wa_79Zn = new TH1F("hEnergy_mult2_wa_79Zn","hEnergy_mult2_wa_79Zn",240,0,6000);
TH1F *hEnergy_mult3_wa_79Zn = new TH1F("hEnergy_mult3_wa_79Zn","hEnergy_mult3_wa_79Zn",240,0,6000);
TH1F *hEnergy_mult4_wa_79Zn = new TH1F("hEnergy_mult4_wa_79Zn","hEnergy_mult4_wa_79Zn",240,0,6000);
...
///................///
    TH1F *hEnergy_mult2_79Zn = new TH1F("hEnergy_mult2_79Zn","hEnergy_mult2_79Zn",240,0,6000);
    TH1F *hEnergy_mult3_79Zn = new TH1F("hEnergy_mult3_79Zn","hEnergy_mult3_79Zn",240,0,6000);
    TH1F *hEnergy_mult4_79Zn = new TH1F("hEnergy_mult4_79Zn","hEnergy_mult4_79Zn",240,0,6000);
///....................///
...
///..............///
    TH2F *h2D_Energy_mult2_wa_79Zn = new TH2F("h2D_Energy_mult2_wa_79Zn","h2D_Energy_mult2_wa_79Zn",186,0,186,240,0,6000);
    TH2F *h2D_Energy_mult3_wa_79Zn = new TH2F("h2D_Energy_mult3_wa_79Zn","h2D_Energy_mult3_wa_79Zn",186,0,186,240,0,6000);
    TH2F *h2D_Energy_mult4_wa_79Zn = new TH2F("h2D_Energy_mult4_wa_79Zn","h2D_Energy_mult4_wa_79Zn",186,0,186,240,0,6000);
...
///.................////
    TH2F *h2D_Energy_mult2_79Zn = new TH2F("h2D_Energy_mult2_79Zn","h2D_Energy_mult2_79Zn",186,0,186,240,0,6000);
    TH2F *h2D_Energy_mult3_79Zn = new TH2F("h2D_Energy_mult3_79Zn","h2D_Energy_mult3_79Zn",186,0,186,240,0,6000);
    TH2F *h2D_Energy_mult4_79Zn = new TH2F("h2D_Energy_mult4_79Zn","h2D_Energy_mult4_79Zn",186,0,186,240,0,6000);
///.................///
    ...
    TH2F *gg_mult4_79Zn = new TH2F("gg_mult4_79Zn","",6000,0,5999,6000,0,5999);//////////////////changed
        ...
        //////79Zn//////////////
            if((fDali[j].t)>-13 && (fDali[j].t)<4 &&DaliTrigger) {
                ...
                if((fDaliMultTa == 2 )&& brzn79 && zdzn79 && fDali[j].idwa >= 60 )
                    hEnergy_mult2_wa_79Zn->Fill(fDali[j].doppwa3);

                if((fDaliMultTa == 3 )&& brzn79 && zdzn79 && fDali[j].idwa >= 60 )
                    hEnergy_mult3_wa_79Zn->Fill(fDali[j].doppwa3);

                if((fDaliMultTa == 4 )&& brzn79 && zdzn79 && fDali[j].idwa >= 60 )
                    hEnergy_mult4_wa_79Zn->Fill(fDali[j].doppwa3);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if((fDali[j].t)>-13 && (fDali[j].t)<4 &&DaliTrigger) {
                    ...
                    if((fDaliMultTa == 2) && brzn79 && zdzn79 && fDali[j].id >= 60)
                        hEnergy_mult2_79Zn->Fill(fDali[j].dopp3);

                    if((fDaliMultTa == 3) && brzn79 && zdzn79 && fDali[j].id >= 60)
                        hEnergy_mult3_79Zn->Fill(fDali[j].dopp3);

                    if((fDaliMultTa == 4) && brzn79 && zdzn79 && fDali[j].id >= 60)
                        hEnergy_mult4_79Zn->Fill(fDali[j].dopp3);
        ...
        for(int j=0;j<fDaliMultTa;j++){
            ...
            if((fDali[j].t)>=-13 && (fDali[j].t)<=4 &&DaliTrigger) {
                ...
                if((fDaliMultTa == 2 )&& brzn79 && zdzn79 )
                    h2D_Energy_mult2_wa_79Zn->Fill(fDali[j].idwa,fDali[j].doppwa1);

                if((fDaliMultTa == 3 )&& brzn79 && zdzn79 )
                    h2D_Energy_mult3_wa_79Zn->Fill(fDali[j].idwa,fDali[j].doppwa1);

                if((fDaliMultTa == 4 )&& brzn79 && zdzn79 )
                    h2D_Energy_mult4_wa_79Zn->Fill(fDali[j].idwa,fDali[j].doppwa1);
        ...
        for(int j=0;j<fDaliFold;j++){
            if(fDali[j].ttrue) {
                ...
                //////78Zn//////////////
                if((fDali[j].t)>=-12 && (fDali[j].t)<=4 &&DaliTrigger) {
                    if((fDaliMultTa == 1) && brzn78 && zdzn78)
                ...
                if((fDali[j].t)>=-9 && (fDali[j].t)<=5 &&DaliTrigger) {
                    ...
                    if((fDaliMultTa == 2) && brzn79 && zdzn79)
                        h2D_Energy_mult2_79Zn->Fill(fDali[j].id,fDali[j].dopp1);

                    if((fDaliMultTa == 3) && brzn79 && zdzn79)
                        h2D_Energy_mult3_79Zn->Fill(fDali[j].id,fDali[j].dopp1);

                    if((fDaliMultTa == 4) && brzn79 && zdzn79)
                        h2D_Energy_mult4_79Zn->Fill(fDali[j].id,fDali[j].dopp1);
     ...
     ///////   Fold spectra
        for(int j=0;j<fDaliFold;j++){
            if(fDali[j].ttrue) {
               //////77Zn//////////////
                if((fDali[j].t)>-13 && (fDali[j].t)<4 && fDali[j].id >= 60 &&DaliTrigger) {
       ...
       //////78Zn//////////////
        ...
        //////78Zn/////
        for(int j=0;j<fDaliMultTa;j++){
            if((fDali[j].t)>-13 && (fDali[j].t)<4 && fDali[j].id >= 60 && DaliTrigger && brzn78 && zdzn78){
                for(int v = 0; v < 186; v++)
                {
        ...
        //////79Zn/////
        for(int j=0;j<fDaliMultTa;j++){
            if((fDali[j].t)>-13 && (fDali[j].t)<4 && fDali[j].id >= 60 && DaliTrigger && brzn79 && zdzn79){
                for(int v = 0; v < 186; v++)
                {
                    if(fDali[v].doppwa2 > 0.)
                    {
                        for(int w = v+1; w < 186; w++)
                        {
                            ...
                            if(fDaliMultTa==4 ){
                                ...
                                gg_mult4_79Zn->Fill(fDali[v].doppwa3,fDali[w].doppwa3);
                                gg_mult4_79Zn->Fill(fDali[w].doppwa3,fDali[v].doppwa3);
...
hEnergy_mult2_wa_79Zn->Write();
hEnergy_mult3_wa_79Zn->Write();
hEnergy_mult4_wa_79Zn->Write();

hEnergy_mult12_wa_79Zn->Write();
hEnergy_mult123_wa_79Zn->Write();
hEnergy_mult1_79Zn->Write();
hEnergy_mult2_79Zn->Write();
hEnergy_mult3_79Zn->Write();
hEnergy_mult4_79Zn->Write();
...
hEnergy_mult123_79Zn->Write();
    ...
    h2D_Energy_mult2_79Zn->Write();
    h2D_Energy_mult3_79Zn->Write();
    h2D_Energy_mult4_79Zn->Write();
    ...
    h2D_Energy_mult2_wa_79Zn->Write();
    h2D_Energy_mult3_wa_79Zn->Write();
    h2D_Energy_mult4_wa_79Zn->Write();
