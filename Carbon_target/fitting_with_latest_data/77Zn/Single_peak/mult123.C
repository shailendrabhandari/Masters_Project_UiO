...
void mult123(){
   ...
   //hexp->Rebin(20);
    ...
    hexp->GetXaxis()->SetRangeUser(450,5000);
    ...
    whole->FixParameter( 4, value691); //  1260 peak 1
    ...
    leg->AddEntry(hexp,"Experiment_C_Mult123_77Zn");
    ...
    fCanvas->Print("77Zn_mult123_C_target.pdf");
}
