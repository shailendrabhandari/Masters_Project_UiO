...
void c_mult123(){
    ...
    sim[1]   = new TFile("78Zn_C_889_Reconstructor_mult1.root");
    sim[2]   = new TFile("78Zn_C_908_Reconstructor_mult1.root");
    sim[3]   = new TFile("78Zn_C_1215_Reconstructor_mult1.root");
   ...
   // }
    ...
    hexp->GetXaxis()->SetRangeUser(370,5000);
    hexp->GetYaxis()->SetRangeUser(0,6000);
    ...
    Double_t norma1 = 0.40;
    Double_t value730 = norma1*0.22;
 ...
 /*   whole->FixParameter( 6, value889); //  889 peak 2
   ...
   // Double_t chi2 = whole->GetChisquare(); ///whole->GetNDF();
    ...
    leg->AddEntry(hexp,"Experiment_C_Mult1 78Zn");
   ...
   // leg->AddEntry(whole, Form("Chi2/NDF = %4.2f", chi2ndf), "l");
    ...
    fCanvas->Print("78Zn_mult1_no_AddBack.pdf");
}
