...
void a_mult1(){
    ...
    sim[0]   = new TFile("78Zn_C_730_Reconstructor_mult1.root");
   ...
   //hexp->Rebin(20);
    ...
    hexp->GetXaxis()->SetRangeUser(400,3500);
    hexp->GetYaxis()->SetRangeUser(1,9000);
    ...
    // /* //01.11.2018
    Double_t norma1 = 0.32;
    Double_t value730 = norma1*0.58;
