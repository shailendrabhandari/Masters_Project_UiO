...
void c_mult123(){
    ...
    sim[0]   = new TFile("730_78Zn_Reconstructor_mult123.root"); 
    sim[1]   = new TFile("890_78Zn_Reconstructor_mult123.root");
    sim[2]   = new TFile("78Zn_C_908_60reconstructor_mult123.root");
    sim[3]   = new TFile("1215_78Zn_Reconstructor_mult123.root");
   ...
   // }
    ...
    hexp->GetYaxis()->SetRangeUser(0,14000);
