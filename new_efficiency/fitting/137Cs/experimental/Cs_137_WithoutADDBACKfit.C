...
void FitRoutine(TCanvas* c1, TH1* histo, float fitxmin, float fitxmax, TString filename){
   ...
   TF1 fitFcn("fitFcn",fitFunction,500,1050,N_PAR);
   fitFcn.SetNpx(500);
   ...
   TF1 backFcn("backFcn",background,565,800,N_PAR);
  ...
  //Integral of a function
   ...
   // int integral1 = backFcn.Integral(573,750)/w;
    int integral2 = fitFcn.Integral(577.5,997.5)/w;
...
void Cs_137_WithoutADDBACKfit() {
   ...
   float fitxmax=3000;
    ...
    TFile* f = new TFile("/home/shailendra/geant4/new_efficiency/fitting/137Cs/experimental/subtracted137Cswithoutaddback.root");
