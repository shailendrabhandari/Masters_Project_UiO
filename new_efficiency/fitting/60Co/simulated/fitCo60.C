...
void FitRoutine(TCanvas* c1, TH1* histo, float fitxmin, float fitxmax, TString filename){
   ...
   TF1 fitFcn("fitFcn",fitFunction1,1070,1245,N_PAR);
   fitFcn.SetNpx(500);
   ...
   histo->GetXaxis()->SetRange(40,200);
...
void fitCo60() {
   ...
   float fitxmax=3000;
    ...
    TFile* f = new TFile("/home/shailendra/geant4/new_efficiency/fitting/60Co/simulated/60CoReconstructor.root");
