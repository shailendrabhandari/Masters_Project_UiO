...
void FitRoutine(TCanvas* c1, TH1* histo, float fitxmin, float fitxmax, TString filename){
   ...
   TF1 fitFcn("fitFcn",fitFunction1,1050,1250,N_PAR);
   fitFcn.SetNpx(500);
   fitFcn.SetLineWidth(2);
   fitFcn.SetLineColor(kRed);

   TF1 fitFcn1("fitFcn1",fitFunction1,1265,1600,N_PAR);
   fitFcn1.SetNpx(500);
   ...
   TF1 backFcn1("backFcn1",background1,1020,1500,N_PAR);
...
int integral2 = fitFcn1.Integral(1265,1600)/w;
