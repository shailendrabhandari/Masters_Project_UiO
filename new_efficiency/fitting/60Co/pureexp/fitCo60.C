...
void FitRoutine(TCanvas* c1, TH1* histo, float fitxmin, float fitxmax, TString filename){
   ...
   TF1 fitFcn("fitFcn",fitFunction,1065,1236,N_PAR);
   fitFcn.SetNpx(500);
...
double w=histo->GetBinWidth(1);
int integral1 = backFcn1.Integral(1250,1810)/w;
int integral2 = fitFcn1.Integral(1250,1810)/w;
...
void fitCo60() {
   ...
   float fitxmax=3000;
    ...
    TFile* f = new TFile("c_60Co_-2000_2000_15_4Feb.root");
