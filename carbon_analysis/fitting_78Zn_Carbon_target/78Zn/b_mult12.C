...
void b_mult12(){
    ...
    sim[0]   = new TFile("78Zn_C_60reconstructor_mult12.root");
   ...
   //hexp->Rebin(20);
    ...
    Double_t norma1 = 0.48;
    Double_t value730 = norma1*0.365;
