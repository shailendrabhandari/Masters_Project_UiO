...
void c_mult123(){
    ...
    sim[0]   = new TFile("/media/shailendra/New Volume/Data_UIO/carbon_analysis/fitting_78Zn_Carbon_target/78Zn/730,889Zn/78Zn_C_Reconstructor_mult123_889root");
   ...
   //hexp->Rebin(20);
    ...
    hexp->GetXaxis()->SetRangeUser(270,3500);
   ...
   // Double_t chi2 = whole->GetChisquare(); ///whole->GetNDF();
    ...
    fCanvas->Print("78Zn_mult123_no_AddBack.png");
}
