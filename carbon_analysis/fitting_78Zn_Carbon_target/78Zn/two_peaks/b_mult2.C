...
void b_mult2(){
    ...
    sim[0]   = new TFile("78Zn_C_60reconstructor_mult2.root");
    sim[1]   = new TFile("78Zn_C_Reconstructor_mult2_ii2+.root");
    ...
    //{
        ...
        hsim[1] = (TH1F*)sim[1]->Get("crystal_fired_doppler_blacklist");
   ...
   // }
    ...
    hexp = (TH1F*)experimental->Get("hEnergy_mult2_78Zn");
    //hp_doppler_22
    ...
    hexp->GetXaxis()->SetRangeUser(270,5000);
    hexp->GetYaxis()->SetRangeUser(0,13000);
    ...
    whole->FixParameter( 8, value1215); //  1215 peak 2
    whole->FixParameter( 8, 16.0);
   ...
   // Double_t chi2 = whole->GetChisquare(); ///whole->GetNDF();
    ...
    leg->AddEntry(hexp,"Data_C_target, hEnergy_mult123_78Zn");
    leg->AddEntry(expon,"Double exponential BG");
    leg->AddEntry(peak0f,"730 keV, h_doppler");
    ...
    fCanvas->Print("78Zn_mult2_no_AddBack.png");
}
