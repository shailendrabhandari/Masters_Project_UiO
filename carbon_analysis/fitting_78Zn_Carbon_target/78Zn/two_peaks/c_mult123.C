...
void c_mult123(){
    ...
    sim[0]   = new TFile("78Zn_C_60reconstructor_mult123.root"); 
    sim[1]   = new TFile("78Zn_C_Reconstructor_mult123_889root");
    sim[2]   = new TFile("78Zn_C_Reconstructor_mult123_ii2+.root");
    
    //The experimental data:
    TFile *experimental = new TFile("final_three_Analysis_yes_dalitrigger.root","READ");
   ...
   // }
    ...
    hexp = (TH1F*)experimental->Get("hEnergy_mult123_78Zn");
    //hp_doppler_22
    ...
    hexp->GetXaxis()->SetRangeUser(280,5000);
    hexp->GetYaxis()->SetRangeUser(0,12000);
    ...
    whole->SetParName(8,"1215 keV");
   
    
    

    Double_t norma1 = 0.56;
    Double_t value730 = norma1*0.27;
   
    //Double_t norma3 = 0.15;
   // Double_t value889 = norma3*0.10;



  // Double_t norma2 = 0.18;
   // Double_t value1215 = norma2*0.12;
    
    
    
    
    whole->FixParameter( 4, value730); //  730 peak 1
    whole->FixParameter( 9, 14.0);
    
    //whole->FixParameter( 6, value889); //  1215 peak 2
    //whole->FixParameter( 7, 14.0);


   ///// whole->FixParameter( 8, value1215); //  1215 peak 3
   // whole->FixParameter( 9, 16.0);
    ...
    peak0f->SetParameter(1,whole->GetParameter(7));
    ...
    peak1f->SetParameter(1,whole->GetParameter(9));
    peak1f->SetLineColor(kMagenta-2);
    ...
    peak2f->SetParameter(0,whole->GetParameter(6));
    peak2f->SetParameter(1,whole->GetParameter(9));
    peak2f->SetLineColor(kMagenta-2);
   ...
   // Double_t chi2 = whole->GetChisquare(); ///whole->GetNDF();
    ...
    leg->AddEntry(hexp,"Experiment_C_Mult123 78Zn");
    ...
    leg->AddEntry(peak2f,"GEANT4 Simulation 1215 keV");
   ...
   // leg->AddEntry(whole, Form("Chi2/NDF = %4.2f", chi2ndf), "l");
    ...
    fCanvas->Print("78Zn_mult123_no_AddBack.pdf");
}
