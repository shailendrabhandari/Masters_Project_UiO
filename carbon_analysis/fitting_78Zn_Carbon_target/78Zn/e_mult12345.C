...
void e_mult12345(){
    ...
    sim[0]   = new TFile("78Zn_C_60reconstructor_mult12345.root");
   ...
   // Double_t chi2 = whole->GetChisquare(); ///whole->GetNDF();
    ...
    fCanvas->Print("78Zn_mult12345_no_AddBack.pdf");
}
