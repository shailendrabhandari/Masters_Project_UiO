...
void f_mult123456(){
    ...
    sim[0]   = new TFile("78Zn_C_60reconstructor_mult123456.root");
    ...
    hexp = (TH1F*)experimental->Get("hEnergy_mult123456_78Zn");
    //hp_doppler_22
   //hexp->Rebin(20);
    hexp->SetStats(0);
    hexp->SetFillColor(0);
    ...
    hexp->GetXaxis()->SetRangeUser(249,4000);
    ...
    Double_t norma1 = 0.66;
    Double_t value730 = norma1*0.33;
   ...
   // Double_t chi2 = whole->GetChisquare(); ///whole->GetNDF();
    ...
    leg->AddEntry(hexp,"Data_C_target, hEnergy_mult123456_78Zn");
    ...
    fCanvas->Print("78Zn_mult123456_no_AddBack.png");
}
