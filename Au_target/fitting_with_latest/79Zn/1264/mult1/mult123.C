...
void mult123(){
    ...
    sim[0]   = new TFile("79Zn_Au_Reconstructor_mult1_1260.root");
    ...
    hexp = (TH1F*)experimental->Get("hEnergy_mult1_79Zn");
    //hp_doppler_22
   //hexp->Rebin(20);
    hexp->SetStats(0);
    hexp->SetFillColor(0);
    ...
    hexp->GetYaxis()->SetRangeUser(1,200);
    ...
    Double_t value1260 = norma1*0.036;
    ...
    leg->AddEntry(hexp,"Experiment_Au_Mult1_79Zn");
