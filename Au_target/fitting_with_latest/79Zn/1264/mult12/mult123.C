...
void mult123(){
    ...
    sim[0]   = new TFile("1264_79Zn_Au_Reconstructor_mult12.root");
    ...
    hexp = (TH1F*)experimental->Get("hEnergy_mult12_79Zn");
    //hp_doppler_22
   //hexp->Rebin(20);
    hexp->SetStats(0);
    hexp->SetFillColor(0);
    ...
    hexp->GetXaxis()->SetRangeUser(500,4000);
    hexp->GetYaxis()->SetRangeUser(1,250);
    ...
    // /* //01.11.2018
    Double_t norma1 = 0.09;
    Double_t value1260 = norma1*0.044;
    ...
    leg->AddEntry(hexp,"Experiment_Au_Mult12_79Zn");
    ...
    fCanvas->Print("79Zn_mult123_Au_target.pdf");
}
