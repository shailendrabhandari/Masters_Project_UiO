...
void mult123(){
    ...
    sim[0]   = new TFile("1264_79Zn_Au_Reconstructor_mult123.root");
   ...
   //hexp->Rebin(20);
    ...
    hexp->GetXaxis()->SetRangeUser(500,5000);
    hexp->GetYaxis()->SetRangeUser(1,300);
    ...
    Double_t value1260 = norma1*0.05;
    ...
    leg->AddEntry(hexp,"Experiment_Au_Mult123_79Zn");
