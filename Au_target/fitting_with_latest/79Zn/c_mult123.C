...
void c_mult123(){
    ...
    sim[0]   = new TFile("983_79Zn_Au_Reconstructor_mult123.root");
    sim[1]   = new TFile("1264_79Zn_Au_Reconstructor_mult123.root");
   ...
   // }
    ...
    hexp->GetXaxis()->SetRangeUser(450,3000);
    hexp->GetYaxis()->SetRangeUser(0,800);
    ...
    whole->FixParameter( 4, value983); //  730 peak 1
    whole->FixParameter( 7, 14.0);
    
    //whole->FixParameter( 6, value2643); //  1215 peak 2
   ...
   // Double_t chi2 = whole->GetChisquare(); ///whole->GetNDF();
    ...
    leg->AddEntry(hexp,"Experiment_Au_Mult123 79Zn");
    leg->AddEntry(expon,"Double exponential BG");
    leg->AddEntry(peak0f,"GEANT4 Simulation 1264 keV");
    leg->AddEntry(peak0f,"GEANT4 Simulation 2643 keV");
   ...
   // leg->AddEntry(whole, Form("Chi2/NDF = %4.2f", chi2ndf), "l");
    ...
    fCanvas->Print("79Zn_Au_mult123_no_AddBack.png");
}
