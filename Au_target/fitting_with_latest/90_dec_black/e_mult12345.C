...
void e_mult12345(){
   ...
   //hexp->Rebin(20);
    ...
    hexp->GetYaxis()->SetRangeUser(1,17000);
    ...
    // /* //01.11.2018
    Double_t norma1 = 0.54;
    Double_t value730 = norma1*0.41;
    ...
    leg->AddEntry(hexp,"Experiment_Au_Mult12345 78Zn");
   ...
   // leg->AddEntry(whole, Form("Chi2/NDF = %4.2f", chi2ndf), "l");
    ...
    fCanvas->Print("78Zn_mult12345_no_AddBack_90blacklisted.png");
}
