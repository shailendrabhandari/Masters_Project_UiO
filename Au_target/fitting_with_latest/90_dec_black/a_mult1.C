...
void a_mult1(){
    ...
    sim[0]   = new TFile("78Zn_Au_90reconstructor_mult1.root");
    
    //The experimental data:
    TFile *experimental = new TFile("three_Analysis_23March_90dec.root");
   ...
   //hexp->Rebin(20);
    ...
    hexp->GetYaxis()->SetRangeUser(1,15000);
    ...
    leg->AddEntry(hexp,"Real data, hEnergy_mult1_78Zn");
    ...
    fCanvas->Print("78Zn_mult1_no_AddBack.png");
}
/*
Number of simulated events: 1000,000
Gamma intensities for different multiplicity:
1. 78Zn_mult1:   0.17980 * 1000000 = 179800
2. 78Zn_mult12:  0.21780 * 1000000 = 217800
3. 78Zn_mult123: 0.24000 * 1000000 = 240000
4. 78Zn_mult1234:0.24320 * 1000000 = 243200
