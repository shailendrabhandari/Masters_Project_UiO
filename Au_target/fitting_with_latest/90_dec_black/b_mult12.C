...
void b_mult12(){
    ...
    sim[0]   = new TFile("730_78Zn_Au_Reconstructor_mult12_90blk.root");
   ...
   //hexp->Rebin(20);
    ...
    hexp->GetYaxis()->SetRangeUser(1,14000);
    ...
    leg->AddEntry(hexp,"Experiment_Au_Mult12 78Zn");
   ...
   // leg->AddEntry(whole, Form("Chi2/NDF = %4.2f", chi2ndf), "l");
    ...
    fCanvas->Print("78Zn_mult12_no_AddBack_90blacklisted.png");
}
