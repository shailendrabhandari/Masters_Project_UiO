...
void c_mult123(){
   ...
   //hexp->Rebin(20);
    ...
    hexp->GetXaxis()->SetRangeUser(450,4500);
    hexp->GetYaxis()->SetRangeUser(1,16000);
    
    hexp->GetYaxis()->SetTitle("Counts (25 keV/bin)");
    hexp->GetXaxis()->SetTitle("Energy (keV)");
    
    hexp->GetXaxis()->SetTitleOffset(0.75);
    hexp->GetXaxis()->CenterTitle();
    hexp->GetYaxis()->SetTitleOffset(0.79);
    ...
    Double_t norma1 = 0.57;
    Double_t value730 = norma1*0.42;
  ...
  //  leg->AddEntry(whole, Form("Chi2/NDF = %4.2f", chi2ndf), "l");
    ...
    fCanvas->Print("78Zn_mult123_no_90blacklisted_AddBack.png");
}
