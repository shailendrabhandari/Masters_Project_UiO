...
void c_mult123(){
    ...
    sim[0]   = new TFile("77Zn_Au_802_Reconstructor_MULT123.root"); 
    sim[1]   = new TFile("77Zn_Au_887_Reconstructor_MULT123.root");
    sim[2]   = new TFile("77Zn_Au_1363_Reconstructor_MULT123.root");
    sim[3]   = new TFile("77Zn_Au_1409_Reconstructor_MULT123.root");
    sim[4]   = new TFile("77Zn_Au_2037_Reconstructor_MULT123.root");
   ...
   // }
    ...
    hexp = (TH1F*)experimental->Get("hEnergy_mult12_77Zn");
    //hp_doppler_22
    ...
    hexp->GetXaxis()->SetRangeUser(250,5000);
    ...
    whole->SetParName(4,"802 keV");
    whole->SetParName(6,"887 keV");
    whole->SetParName(8,"1363 keV");
   ...
   // whole->SetParName(14,"2626 keV");
    ...
    Double_t norma1 = 0.042;
    Double_t value802 = norma1*0.014;
   
    Double_t norma2 = 0.048;
    Double_t value887 = norma2*0.010;



    Double_t norma3 = 0.078;
    Double_t value1363 = norma3*0.012;




    Double_t norma4 = 0.09;
    Double_t value1409 = norma4*0.018;


    Double_t norma5 = 0.18;
    Double_t value2037 = norma5*0.026;
   ...
   // Double_t value2626 = norma6*0.018;
    ...
    whole->FixParameter( 12, value2037); //  2037 peak 5
...
*/
   ...
   // Double_t chi2 = whole->GetChisquare(); ///whole->GetNDF();
    ...
    leg->AddEntry(hexp,"Experiment_Au_Mult123 77Zn");
