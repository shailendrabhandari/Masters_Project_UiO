...
void c_mult123(){
    ...
    sim[0]   = new TFile("77Zn_Au_691_Reconstructor_MULT123.root"); 
    sim[1]   = new TFile("77Zn_Au_887_Reconstructor_MULT123.root");
    sim[2]   = new TFile("77Zn_Au_1170_Reconstructor_MULT123.root");
   ...
   // }
    ...
    hexp->GetYaxis()->SetRangeUser(0,500);
    ...
    Double_t value691 = norma1*0.02;
   
    Double_t norma2 = 0.058;
    Double_t value887 = norma2*0.018;



    Double_t norma3 = 0.09;
    ...
    whole->FixParameter( 5, 1.0);
    
    whole->FixParameter( 6, value887); //  887 peak 2
    whole->FixParameter( 7, 1.0);

    whole->FixParameter( 8, value1170); //  1936 peak 3
    whole->FixParameter( 9, 4.0);


    whole->FixParameter( 10, value1409); //  4147 peak 4
    whole->FixParameter( 11, 2.0);
   ...
   // leg->AddEntry(whole, Form("Chi2/NDF = %4.2f", chi2ndf), "l");
    ...
    fCanvas->Print("77Zn_mult123_Au_NoAddBack.pdf");
}
