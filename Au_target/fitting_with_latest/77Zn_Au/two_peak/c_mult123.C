...
void c_mult123(){
   ...
   // }
    ...
    hexp->GetXaxis()->SetRangeUser(440,5000);
    ...
    whole->FixParameter( 4, value691); //  730 peak 1
    whole->FixParameter( 7, 14.0);
    
    whole->FixParameter( 6, value887); //  1215 peak 2
    whole->FixParameter( 7, 14.0);
   ...
   // leg->AddEntry(whole, Form("Chi2/NDF = %4.2f", chi2ndf), "l");
    ...
    fCanvas->Print("77Zn_mult123_C_no_AddBack.png");
}
