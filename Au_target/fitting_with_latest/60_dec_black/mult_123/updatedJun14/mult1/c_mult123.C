...
void c_mult123(){
   ...
   // }
    ...
    hexp->GetXaxis()->SetRangeUser(490,5000);
   ...
   // peak3g  = new TGraph(hsim[3]);
    ...
    Double_t norma1 = 0.52;
    Double_t value730 = norma1*0.169;
   
    Double_t norma2 = 0.14;
    Double_t value889 = norma2*0.1;

    Double_t norma3 = 0.108;
    Double_t value1215 = norma3*0.11;
   ...
   /* 
    ...
    whole->FixParameter( 8, value1215); //  908 peak 3
...
/*
   ...
   // Double_t chi2 = whole->GetChisquare(); ///whole->GetNDF();
    ...
    leg->AddEntry(peak1f,"GEANT4 Simulation 1015 keV");
