...
void c_mult123(){
    ...
    sim[0]   = new TFile("730_78Zn_Au_Reconstructor_mult123_90blk.root"); 
   // sim[1]   = new TFile("889_78Zn_Au_Reconstructor_mult123.root");
   // sim[2]   = new TFile("908_78Zn_Au_Reconstructor_mult123.root");
    sim[1]   = new TFile("1215_78Zn_Au_Reconstructor_mult123.root");
   ...
   // }
    ...
    hexp->GetYaxis()->SetRangeUser(0,15000);
   ...
   // peak3g  = new TGraph(hsim[3]);
    ...
    whole->SetParName(6,"1215 keV");
    

    //whole->SetParName(6,"p4");
    ...
    Double_t norma1 = 0.46;
    Double_t value730 = norma1*0.28;
   

    Double_t norma2 = 0.18;
    Double_t value1215 = norma2*0.109;
    ...
    */
    ...
    whole->FixParameter( 6, value1215); //  889 peak 2
...
/*
    ...
    TF1 *peak3f = new TF1("peak2f",resp3,fitmin,fitmax,2); //
    peak3f->SetParameter(0,whole->GetParameter(6));
    peak3f->SetParameter(1,whole->GetParameter(7));
   ...
   // Double_t chi2 = whole->GetChisquare(); ///whole->GetNDF();
    ...
    leg->AddEntry(hexp,"Experiment_Au_Mult123 78Zn");
    ...
    leg->AddEntry(peak1f,"GEANT4 Simulation 1215 keV");
   ...
   // leg->AddEntry(whole, Form("Chi2/NDF = %4.2f", chi2ndf), "l");
    ...
    fCanvas->Print("78Zn_Au_mult123_no_AddBack.pdf");
}
