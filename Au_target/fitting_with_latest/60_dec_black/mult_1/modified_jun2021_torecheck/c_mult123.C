...
void c_mult123(){
   ...
   // }
    ...
    Double_t value730 = norma1*0.23;
   
    //Double_t norma2 = 0.1;
   // Double_t value889 = norma2*0.05;

    Double_t norma3 = 0.08;
    Double_t value908 = norma3*0.04;




    //Double_t norma4 = 0.12;
   // Double_t value1215 = norma4*0.11;
