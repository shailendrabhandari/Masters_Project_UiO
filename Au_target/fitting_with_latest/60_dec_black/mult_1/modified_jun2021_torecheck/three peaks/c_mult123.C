...
void c_mult123(){
    ...
    sim[1]   = new TFile("78Zn_Reconstructor_Au908_mult1.root");
   ...
   // whole->SetParName(10,"1215 keV");
    ...
    Double_t norma1 = 0.60;
    Double_t value730 = norma1*0.16;
   
    Double_t norma2 = 0.14;
    Double_t value908 = norma2*0.10;
    ...
    */
    ...
    whole->FixParameter(11, 14.0);
    
    whole->FixParameter( 6, value908); //  889 peak 2
...
*/
   ...
   // Double_t chi2 = whole->GetChisquare(); ///whole->GetNDF();
    ...
    leg->AddEntry(peak1f,"GEANT4 Simulation 908 keV");
