...
void f_mult123456(){
    ...
    sim[0]   = new TFile("78Zn_Au_reconstructor_mult123456.root");
   ...
   //hexp->Rebin(20);
    ...
    hexp->GetXaxis()->SetRangeUser(490,4000);
    hexp->GetYaxis()->SetRangeUser(1,40000);
    ...
    leg->AddEntry(hexp,"Real data, hEnergy_mult123456_78Zn");
