...
void e_mult12345(){
    ...
    sim[0]   = new TFile("78Zn_Au_reconstructor_mult12345.root");
    
    //The experimental data:
    TFile *experimental = new TFile("three_Analysis_24Feb2021.root","READ");
    ...
    hexp = (TH1F*)experimental->Get("hEnergy_mult12345_78Zn");
    //hp_doppler_22
   //hexp->Rebin(20);
    hexp->SetStats(0);
    hexp->SetFillColor(0);
    ...
    hexp->GetXaxis()->SetRangeUser(475,3400);
    hexp->GetYaxis()->SetRangeUser(1,35000);
    
    hexp->GetYaxis()->SetTitle("Counts"); ///("Counts (25 keV/bin)")
    ...
    leg->AddEntry(hexp,"Real data, hEnergy_mult12345_78Zn");
    ...
    fCanvas->Print("78Zn_mult12345_no_AddBack.png");
}
