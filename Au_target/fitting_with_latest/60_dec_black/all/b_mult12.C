...
void b_mult12(){
    ...
    sim[0]   = new TFile("78Zn_Au_reconstructor_mult12.root");
    
    //The experimental data:
    TFile *experimental = new TFile("three_Analysis_09March_full_run34.root","READ");
    TCanvas *fCanvas=new TCanvas("Canvas","78Zn",800,500);
    fCanvas->cd();
    ...
    hexp = (TH1F*)experimental->Get("hEnergy_mult12_78Zn");
    //hp_doppler_22
   //hexp->Rebin(20);
    hexp->SetStats(0);
    hexp->SetFillColor(0);
    ...
    hexp->GetXaxis()->SetRangeUser(460,3500);
    hexp->GetYaxis()->SetRangeUser(1,30000);
    
    hexp->GetYaxis()->SetTitle("Counts (25 keV/bin)");
    hexp->GetXaxis()->SetTitle("Energy (keV)");
    
    hexp->GetXaxis()->SetTitleOffset(0.73);
    hexp->GetXaxis()->CenterTitle();
    hexp->GetYaxis()->SetTitleOffset(0.96);
    ...
    // /* //01.11.2018
    Double_t norma1 = 0.72;
    Double_t value730 = norma1*0.30;
    ...
    leg->AddEntry(hexp,"Real data, hEnergy_mult12_78Zn");
    leg->AddEntry(expon,"Double exponential BG");
    leg->AddEntry(peak0f,"730 keV,GEANT DALI2 response function");
   ...
   // leg->AddEntry((TObject*)0, "", "");
    ...
    fCanvas->Print("78Zn_mult12_no_AddBack.pdf");
}
