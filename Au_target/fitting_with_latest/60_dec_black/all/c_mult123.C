...
void c_mult123(){
    ...
    sim[0]   = new TFile("78Zn_Au_reconstructor_mult123.root");
   ...
   //hexp->Rebin(20);
    ...
    hexp->GetXaxis()->SetRangeUser(470,3500);
    ...
    Double_t norma1 = 0.59;
    Double_t value730 = norma1*0.38;
   ...
   // Double_t chi2 = whole->GetChisquare(); ///whole->GetNDF();
    ...
    leg->AddEntry(hexp,"Real data, hEnergy_mult123_78Zn");
