...
void d_mult1234(){
    ...
    sim[0]   = new TFile("78Zn_Au_reconstructor_mult1234.root");
   ...
   //hexp->Rebin(20);
    ...
    hexp->GetXaxis()->SetRangeUser(480,3500);
    ...
    leg->AddEntry(hexp,"Real data, hEnergy_mult1234_78Zn");
    ...
    fCanvas->Print("78Zn_mult1234_no_AddBack.pdf");
}
